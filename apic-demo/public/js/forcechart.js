...
app.directive('forceChart', ['$http', 'theme', 'util', function ($http, theme, util) {
                return {
                        restrict: 'E',                       
                        scope: {
                            id:"@",
                        ...
                        template: '<div style="height:600px;",nodes="{{nodes}}",links="{{links}}"></div>',
                        replace: true,
                link: getLinkFunction1($http, theme, util)
                };
        }]);
function getLinkFunction1($http, theme, util) {
    return function (scope, element, attrs) {
        function setOptions() {
                    if (!scope.nodes || !scope.links) {
                       ...
                       var chart = echarts.init(document.getElementById(scope.id), 'macarons');
                       chart.setOption(options);
